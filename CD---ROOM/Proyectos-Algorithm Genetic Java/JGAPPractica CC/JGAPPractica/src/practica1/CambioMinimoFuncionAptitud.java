...
//		int Moneda1Centimo = getNumeroDeComendasDeGen(cromosoma, 7);
		...
		int Moneda1Centavos = getNumeroDeComendasDeGen(cromosoma, 5);
//                int Moneda2Centimos = getNumeroDeComendasDeGen(cromosoma, 6);
//		int Moneda1Centimo = getNumeroDeComendasDeGen(cromosoma, 7);

		return (Moneda1Dolar * 100) + (Moneda50Centavos * 50) + (Moneda25Centavos * 25) + (Moneda10Centavos * 10) + (Moneda5Centavos * 5) + (Moneda1Centavos * 1);
	}
